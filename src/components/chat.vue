<script setup>
	...
	const messages = ref([
		...
		{
			content: 'MerhabaMerhabaMerhabaMerhabaMerhabaMerhabaMerhabaMerhaba',
			sender: false,
		},
		{ content: 'Merhaba', sender: true },
...
<template>
	<div ref="swiperEl" class="swiper-chat" @touchstart.passive="touchStart" @touchmove.passive="touchMove" @touchend.passive="touchEnd" :style="swiperStyle">
		<div class="chat">
			<header>
			...
			<footer>
				<Icon icon="mdi:plus" />
				<input type="text" v-model="inputText" @focus="inputFocused = true" @blur="inputFocused = false" @keyup.enter="sendMessage" placeholder="Mesajınızı yazın..." />
